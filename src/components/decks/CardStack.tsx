...
function getCardStackStyle(index: number, activeCardIndex: number, totalCards: number): CardStackStyle {
  ...
  return {
    ...
    style: {
      ...
      "--past-brightness": Math.max(0.88, 1 - pastDepthForTone * 0.013),
      "--past-contrast": Math.max(0.95, 1 - pastDepthForTone * 0.005),
      "--past-saturation": Math.max(0.88, 1 - pastDepthForTone * 0.013),
      "--past-shadow-alpha": Math.max(0.09, 0.18 - pastDepthForTone * 0.01),
